...
export const TURKISH_WORDS = [
  "a", "o", "ev", "su", "at", "ýþ", "göz", "el", "kar", "gün", "yol", "den",
  "kitap", "okul", "masa", "saat", "kalem", "pencere", "kapý", "bahçe", "þehir",
  "arkadaþ", "çocuk", "istanbul", "ankara", "izmir", "güzellik", "mutluluk",
  "çalýþmak", "öðrenci", "öðretmen", "bilgisayar", "televizyon", "programlama",
  "deneyim", "hayat", "düþünce", "görüþ", "uzmanlýk", "müzik", "resim", "sanat",
  "doða", "manzara", "alýþveriþ", "yazýlým", "donaným", "veritabaný", "aðaçlar",
  "güneþ", "yaðmur", "karanlýk", "aydýnlýk", "mutfaðýmýz", "sevgilim", "arkadaþlar"
];
