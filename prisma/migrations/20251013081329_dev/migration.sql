...
-- CreateIndex
CREATE UNIQUE INDEX "Article_articleTestId_key" ON "public"."Article"("articleTestId");
...
-- AddForeignKey
ALTER TABLE "public"."Attempt" ADD CONSTRAINT "Attempt_exerciseId_fkey" FOREIGN KEY ("exerciseId") REFERENCES "public"."Exercise"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Article" ADD CONSTRAINT "Article_articleTestId_fkey" FOREIGN KEY ("articleTestId") REFERENCES "public"."ArticleTest"("id") ON DELETE SET NULL ON UPDATE CASCADE;
