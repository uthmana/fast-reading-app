export var menuItems = [
    ...
    },
    {
        ...
        subMenu: [
            ...
            { name: "coklu-pencere", link: "/goz-egzersiz/coklu-pencere" },
            {
        ...
        description: "Göz egzersizlerindeki temel amaç göze hız kazandırmak, göz kaslarını güçlendirmek, gözün görme çevikliğini artırmak. Bu uygulamadan yeterince yararlanmak için her egzersizi 1. sevi- den 5. seviyeye kadar kademe kademe uygulayınız.",
    ...
    },
    {
        ...
        description: "Okuma egzersizlerindeki temel amaç göze hız kazandırmak, göz kaslarını güçlendirmek, gözün kelimeleri hızlı tanımasını sağlamak.Bu uygulamadan yeterince yararlanmak için her egzersizi 1. seviden 5. seviyeye kadar kademe kademe uygulayınız.",
        youtubeId: "xiTK523Ot5U",
    },
    {
        name: "Takistoskop",
        ...
        description: "Hızlı Görme Uygulaması Takistoskop çalışmaları, gözün kelime veya kelime gruplarını 100ms ile 1000ms (1sn=1000ms) arasında bir hızla gösterip, gözünüzün görme hızını arttırır.",
        youtubeId: "xiTK523Ot5U",
    },
    {
        name: "Hızlı Oku",
        ...
        subMenu: [
            ...
            {
                name: "Silinmeden Okuma",
                link: "/hizli-oku/okuma",
            },
        ],
