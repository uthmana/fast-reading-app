...
export default function page() {
    ...
    return (<Whiteboard description={<ControlPanelGuide />} body={<RenderExercise controls={__assign(__assign({}, control), { text: selectedArticle === null || selectedArticle === void 0 ? void 0 : selectedArticle.description, level: (control === null || control === void 0 ? void 0 : control.level) * 30000, wordsPerFrame: control === null || control === void 0 ? void 0 : control.wordsPerFrame })}/>} onControl={handleControl}/>);
}
