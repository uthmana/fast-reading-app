...
export default function page() {
    ...
    useEffect(function () {
        var fetchData = function () { return __awaiter(_this, void 0, void 0, function () {
            var res, resData, allData, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        resData = _a.sent();
                        allData = resData.map(function (dVal) {
                            var user = dVal.user, rest = __rest(dVal, ["user"]);
                            var id = user.id, uersRest = __rest(user, ["id"]);
                            return __assign(__assign({}, uersRest), { id: rest.id, level: rest.level, startDate: rest.startDate, endDate: rest.endDate, studentId: rest.id });
                        });
                        setStudents(allData);
                        setIsloading(false);
                        _a.label = 3;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (actionType === "edit") {
                        setData(__assign(__assign({}, currentUser), { startDate: (_b = currentUser.startDate) === null || _b === void 0 ? void 0 : _b.split("T")[0], endDate: (_c = currentUser.endDate) === null || _c === void 0 ? void 0 : _c.split("T")[0] }));
                        setIsShowPopUp(true);
                    }
    ...
    return (<div className="w-full">
      ...
      <TableBuilder isLoading={isLoading} key={isLoading} tableData={students} columnKey="studentColumn" onAction={handleAction} onAdd={handleAction}/>
      ...
      <Popup show={isShowPopUp} onClose={function () { return setIsShowPopUp(false); }} title="Öğrenci Ekle" bodyClass="flex flex-col gap-3 py-6 px-8">
        <FormBuilder id={"student"} data={data} onSubmit={function (values) {
