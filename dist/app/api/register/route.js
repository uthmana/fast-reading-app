...
export function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, id, name, email, password, role, active, userExit, pwd, _b, user_1, hashedPassword, user, err_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, req.json()];
                case 1:
                    _a = _c.sent(), id = _a.id, name = _a.name, email = _a.email, password = _a.password, role = _a.role, active = _a.active;
                ...
                case 6:
                    ...
                    return [4 /*yield*/, prisma.user.update({
                            where: { id: id },
                            data: { name: name, email: email, password: pwd, role: role, active: active },
                        })];
                case 7:
                    user_1 = _c.sent();
