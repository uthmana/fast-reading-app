...
export function GET(req) {
    return __awaiter(this, void 0, void 0, function () {
        var students, e_1, _a, userMessage, technicalMessage;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    students = _b.sent();
                    return [2 /*return*/, NextResponse.json(students, { status: 200 })];
                case 2:
                    e_1 = _b.sent();
...
export function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, id, name, email, password, role, active, startDate, endDate, level, userExit, pwd, _b, user_1, hashedPassword, user, err_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, req.json()];
                case 1:
                    _a = _c.sent(), id = _a.id, name = _a.name, email = _a.email, password = _a.password, role = _a.role, active = _a.active, startDate = _a.startDate, endDate = _a.endDate, level = _a.level;
                ...
                case 3:
                    ...
                    if (!(userExit.user.password !== password)) return [3 /*break*/, 5];
                    return [4 /*yield*/, bcrypt.hash(password, 10)];
                case 4:
                    _b = _c.sent();
                    return [3 /*break*/, 6];
                case 5:
                    _b = userExit.user.password;
                    _c.label = 6;
                case 6:
                    pwd = _b;
                ...
                case 11:
                    err_1 = _c.sent();
                    console.log(err_1);
                    return [2 /*return*/, NextResponse.json({ error: "Student already exists" }, { status: 400 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    err_2 = _a.sent();
                    console.log(err_2);
                    return [2 /*return*/, NextResponse.json({ error: "Student does not exists" }, { status: 400 })];
