...
export default function ControlPanelGuide(_a) {
    var _b;
    var _c = _a.showOptionSelect, showOptionSelect = _c === void 0 ? false : _c;
    var pathname = usePathname();
    var menu = menuItems.find(function (item) {
        return item.subMenu.find(function (sub) { return sub.link === pathname; });
    });
    var title = ((_b = menu === null || menu === void 0 ? void 0 : menu.subMenu.find(function (sub) { return sub.link === pathname; })) === null || _b === void 0 ? void 0 : _b.name) ||
        "Kontrol Paneli Nasıl Kullanılır";
    return (<div className=" text-gray-800 lg:max-w-[90%] max-w-full !text-lg mx-auto">
