...
export default function WhiteboardCopy({
  ...
  const [controlVal, setControlVal] = useState({
    ...
    scroll: { value: 1 },
    //Find the Color
    checkCorrect: { value: false },
    displayCorrectAnswer: { value: 0 },
    displayWrongAnswer: { value: 0 },
    displayNetAnswer: { value: 0 },
    // FindTheWord
    levelWord: { value: 1 },
    difficultyWord: { value: 1 },
    checkCorrectWord: { value: false },
    displayCorrectAnswerWord: { value: 0 },
    displayWrongAnswerWord: { value: 0 },
    displayNetAnswerWord: { value: 0 },
  } as any);
