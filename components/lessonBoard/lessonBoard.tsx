  ...
  return (
    <div className={`flex w-full flex-col ${className}`}>
      <div className="relative w-full overflow-hidden rounded-md border border-gray-400 min-h-[520px] mx-auto mb-7 flex items-center justify-center shadow-[0_2px_6px_rgba(0,0,0,0.3)]">
        ...
        <div className="absolute top-[3%] flex flex-col items-center justify-center left-[2%] w-[96%] h-[94%] bg-white px-5 py-4 z-[2] overflow-y-auto text-gray-800 rounded shadow-[inset_0_4px_10px_rgba(0,0,0,0.25)] bg-gradient-to-r from-[#1D63F0] to-[#1AD7FD] ">
