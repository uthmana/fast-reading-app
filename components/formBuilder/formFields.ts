...
export default {
  ...
  registerStudent: [
    ...
    },
    {
      ...
      type: "select",
      options: [],
      asyncOption: getSubscriberOptions,
      dependentKey: "classId",
      value: { key: "subscriberId", type: "number", value: [] },
      required: true,
      styleClass: "!w-[calc(50%-6px)]",
    },
    {
      ...
      type: "select",
      options: [],
      asyncOptionById: getClassOptionsById,
      optionId: null,
      value: { key: "classId", type: "number", value: [] },
      required: true,
      styleClass: "!w-[calc(50%-6px)]",
    },
    {
  ...
  article: [
    {
      ...
      type: "select",
      options: [],
      asyncOption: getStudyGroupOptions,
      multipleSelect: true,
    ...
    },
    {
      ...
      multipleSelect: true,
      value: { key: "categories", type: "multipleSelect", value: [] },
      required: true,
      styleClass: "md:!w-[calc(50%-6px)]",
    },
    {
  ...
  registerClasses: [
    ...
    },
    {
      ...
      type: "select",
      options: [],
      asyncOptionById: getTeacherOptionsById,
      optionId: null,
      value: { key: "teacherId", type: "number", value: [] },
      required: true,
      styleClass: "!w-[calc(50%-6px)]",
    },
    {
